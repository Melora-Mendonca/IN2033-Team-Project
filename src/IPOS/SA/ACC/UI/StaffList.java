...
public class StaffList extends JFrame {
    ...
    private void createHeaderPanel() {
        ...
        headerLabel = new JLabel("Staff List");
    ...
    private void searchStaff() {
        ...
        try {
            ...
            statusLabel.setText(filteredStaff.size() + " staff member(s) found");
